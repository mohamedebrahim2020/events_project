 ...
 * @endcode
 */
$settings['hash_salt'] = 'VJFKBH7NjnmWxhFB4BtDYkqKuhv0zG43qKSRrdtSf2bAOmmFInoA0zVX7NcnlStnNqqDt4w1KQ';
...
$settings['trusted_host_patterns'] = [
	'^localhost$',
	'^127\.0\.0\.1$',
	'events.local', // Replace with your actual domain.
];
...
$settings['config_sync_directory'] = 'sites/default/files/config_lHfVtFjuK0RB-wVaFWml_zAGgQDY03Cn4_TsG_Q-rKbrpbiawlQ7Gvr60DWa8vRuo9jn1kpQ2Q/sync';
